...
PRODUCT_COPY_FILES += \
    ...
    vendor/samsung/matisse3g/proprietary/etc/Diag_audio.cfg:system/etc/Diag_audio.cfg \
    vendor/samsung/matisse3g/proprietary/etc/Diag.cfg:system/etc/Diag.cfg \
    vendor/samsung/matisse3g/proprietary/etc/Diag_gps.cfg:system/etc/Diag_gps.cfg \
    vendor/samsung/matisse3g/proprietary/etc/Diag_volte.cfg:system/etc/Diag_volte.cfg \
    vendor/samsung/matisse3g/proprietary/etc/Diag_zero.cfg:system/etc/Diag_zero.cfg \
    vendor/samsung/matisse3g/proprietary/etc/plmn_se13.bin:system/etc/plmn_se13.bin \
    vendor/samsung/matisse3g/proprietary/etc/srm.bin:system/etc/srm.bin \
